...
slash-graphql/1.12.0 linux-x64 node-v10.19.0
...
_See code: [src/commands/deploy-backend.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/deploy-backend.ts)_
...
_See code: [src/commands/destroy-backend.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/destroy-backend.ts)_
...
EXAMPLE
  $ slash-graphql drop-data -e https://frozen-mango.cloud.dgraph.io/graphql -t <apiToken> [-l] [-d] [-s] [-T <types>] 
  [-F <fields>]
```

_See code: [src/commands/drop.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/drop.ts)_
...
_See code: [src/commands/export-data.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/export-data.ts)_
...
_See code: [src/commands/get-schema.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/get-schema.ts)_
...
_See code: [src/commands/import-data.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/import-data.ts)_
...
_See code: [src/commands/list-backends.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/list-backends.ts)_
...
_See code: [src/commands/login.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/login.ts)_
...
_See code: [src/commands/logout.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/logout.ts)_
...
_See code: [src/commands/restore-backend.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/restore-backend.ts)_
...
_See code: [src/commands/restore-backend-status.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/restore-backend-status.ts)_
...
_See code: [src/commands/update-backend.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/update-backend.ts)_
...
_See code: [src/commands/update-schema.ts](https://github.com/dgraph-io/slash-graphql-cli/blob/v1.12.0/src/commands/update-schema.ts)_
<!-- commandsstop -->
